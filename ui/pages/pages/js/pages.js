...
(function(window) {
    ...
    SelectFx.prototype._initEvents = function() {
        ...
        this.selPlaceholder.addEventListener('click', function() {
            self._toggleSelect();
            var placeHolderHTML = $(this).text();
            $(this).parent().find('.cs-options').find('li').each(function() {
                if($(this).find('span').text() == placeHolderHTML) {
...
(function($) {
    ...
    /*
    $(document).on('[data-toggle="quickview"]', function(e) {
 ...
 (function($) {
    ...
    var Sidebar = function(element, options) {
     ...
     Sidebar.prototype.toggleSidebar = function(toggle) {
         var timer;
         var sidebarToggles = body.find('.toggle-sidebar');
         if (this.$body.hasClass('sidebar-open')) {
             // CLOSE SIDEBAR
             this.$body.removeClass('sidebar-open');
             if(!banner2.hasClass('hidden'))
                 banner2.addClass('hidden');
