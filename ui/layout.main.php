                ...
                <div class="d-flex align-items-center margin-right-neg-15">
                    ...
                    <div class="dropdown pull-right">
                        <button class="profile-dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="thumbnail-wrapper d32 circular inline" style="cursor: pointer"><?php $src = EGOV2_CITIZEN_AVATAR_DIR . $arr_admin_details['avatar']; ret(1); ?>
                                <img id="imgProfile" src="<?php echo $src; ?>" data-src="<?php echo $src; ?>" data-src-retina="<?php echo $src; ?>" alt="[img]">
                            </span>
                        </button>
                        <div class="dropdown-menu dropdown-menu-right profile-dropdown" role="menu">
                            <a class="dropdown-item cursor-pointer" id="btnModifyPassword"><i class="fa fa-key"></i> Password</a>
