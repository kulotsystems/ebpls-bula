...
?>
    ...
    <head>
        ...
        <meta name='description' content='2020 Business Permit | Electronic Business Permit and Licensing System'>
    ...
    <div align='center'>
        <div class='page'>
            <img class='p-img' src='<?php echo INDEX; ?>/inc/permits/img/[Nabua] 2020.jpg'>
            ...
            <div class='p-field p-applicant-address'      data-w='64.71' data-h='01.97' data-x='26.90' data-y='40.89' data-value='invoice.verification.application.home_address'><table><tr><td align='left' class='padding-left-10 text-bold text-uppercase'>[RESIDENCES / ADDRESS]</td></tr></table></div>
            ...
            <div class='p-field p-business-line-desc'     data-w='68.82' data-h='04.09' data-x='23.10' data-y='47.12' data-value='invoice.verification.application.business_activities[0].business_line_title'><table><tr><td align='center' class='text-bold text-italic text-uppercase' valign='top'>[LINE OF BUSINESS]</td></tr></table></div>
            ...
            <div class='p-field p-mayors-permit-fee'      data-w='11.22' data-h='01.52' data-x='69.29' data-y='79.73'><table><tr><td align='left' class='sm padding-left-5 text-bold'>&#8369; 0.00</td></tr></table></div>
            <div class='p-field p-or-number'              data-w='27.04' data-h='01.52' data-x='68.51' data-y='81.42' data-value='invoice.fees_payment_invoice.or_no'><table><tr><td align='left' class='sm padding-left-5 text-bold'>0000000000</td></tr></table></div>
            <div class='p-field p-issued-on date-only'    data-w='17.65' data-h='01.52' data-x='62.98' data-y='83.12' data-value='invoice.fees_payment_invoice.or_date'><table><tr><td align='left' class='sm padding-left-5 text-bold'>[OR DATE]</td></tr></table></div>
        </div>
    </div>
